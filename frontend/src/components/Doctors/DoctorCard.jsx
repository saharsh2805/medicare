    ...
    <div className='p-3 lg:p-5'>
        ...
        <h2 className='text-[18px] leading-[30px] lg:text-[20px] lg:leading-9 text-headingColor font-[700] mt-3 lg:mt-5'>
            ...
            <div className='mt-[18px] lg:mt-5 flex items-center justify-between'>
                <div>
                  { /* <h3 className='text-[10px] leading-7 lg:text-[18px] lg:leading-[30px] font-semibold text-headingColor'>
                        +{totalPatients} patients</h3> */ }
                        <p className='text-[14px] leading-7 font-[400] text-textColor'>{experiences && experiences[0]?.hospital}</p>
                </div>
